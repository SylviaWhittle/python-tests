...
* Gwyddion is a software written in C++
...
* PyGwy is a Python binding to Gwyddion's methods and functions.
    + Python 2.7 and confirmed not going to be updated to 3.X.
 

:::
::: {.column width="50%"}
* Contributing to TopoStats was a mess. 
* All values and configuration was hard-coded.
...
Note from Neil's presentation
More background for the science of TopoStats?
Perhaps add graphs for the old and new software?